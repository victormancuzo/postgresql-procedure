...
ALTER TABLE
    IF EXISTS public.tipo_pessoa OWNER to postgres;
...
CREATE TABLE IF NOT EXISTS public.pessoa (
    ...
    CONSTRAINT pessoa_id_tipo_pessoa_fkey FOREIGN KEY (id_tipo_pessoa) REFERENCES public.tipo_pessoa (id_tipo_pessoa) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION
) TABLESPACE pg_default;

ALTER TABLE
    IF EXISTS public.pessoa OWNER to postgres;

CREATE
OR REPLACE PROCEDURE public.cadastrar_pessoa(
...
INSERT INTO
    pessoa (nome, cpf_cnpj, data_nascimento, id_tipo_pessoa)
VALUES
    (
        p_nome,
        p_cpf_cnpj,
...
ALTER PROCEDURE public.cadastrar_pessoa(
    character varying,
    character varying,
    date,
    integer
